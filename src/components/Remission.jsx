...
const Remission = () => {
  ...
  return (
    <section className={`flex flex-col justify-center items-center fixed inset-0 bg-black/20 backdrop-blur-sm transform transition-transform duration-200 ease ${openRemission && 'scale-0'}`} >
      <section className='' >
      </section>
      ...
      <form onSubmit={handleSubmit(Submit)} className=' md:w-11/12 xl:w-10/12 bg-white border p-1 md:p-2  xl:p-2 rounded-lg h-[90vh] overflow-y-auto '>
        <div className="bg-[#1e4e8c] text-white p-1 text-center  text-3xl">
          REMISIÓN
        </div>
        <div className=" flex flex-col md:flex-row xl:flex-row p-2.5">
          <div className='flex justify-center items-center'>
            <img alt="Logo de Suministros Industriales" src="\logo suministros industriales.png" width="300" />
          </div>
          <div className='w-full md:w-3/4 xl:w-3/4 justify-center items-center '>
        ...
        <section className='flex justify-center'>
          <button className=" w-10/12  py-2 rounded-full text-white bg-blue-500 hover:bg-blue-600">GUARDAR</button>
        </section>
      </form>
    </section>
  )
