...
const MaterialList = () => {
  ...
  return (
    <div className={` ${OpenCloseMaterialList && 'scale-0'} fixed inset-0 bg-black/20 backdrop-blur-sm flex flex-col items-center `} >
      ...
      <section className="w-11/12 md:w-8/12 xl:w-5/12 bg-white rounded" >
