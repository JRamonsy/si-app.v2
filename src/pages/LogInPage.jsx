  ...
  return (
    <div>
      <div className={`fixed w-full h-full flex justify-center items-center bg-slate-900 transform transition-transform duration-200 ease `}>
        <form onSubmit={handleSubmit(Submit)} className='w-2/6 shadow-2xl shadow-cyan-400/50  bg-white rounded-[25px] flex flex-col items-center py-8 px-2' action="">
          ...
          <section className='w-full flex flex-col items-center'>
            <div className='flex flex-col w-5/6 my-4 '>
              ...
              <input className='border border-black rounded-[6px] px-4 py-1' {...register('userName')} type="text" />
            </div>
            <div className='flex flex-col w-5/6 my-'>
              <label className='text-center text-slate-500 font-bold'>Contraseña</label>
              <input className='border border-black rounded-[6px] px-4 py-1' {...register('password')} type="password" />
            </div>
            <div className='w-full flex justify-center items-center'>
              <button className='w-5/6 bg-blue-600 text-white text-2xl font-bold my-4 py-1 rounded-[6px] hover:bg-blue-500'>INGRESAR</button>
            </div>
          </section>
        </form>
      </div>
