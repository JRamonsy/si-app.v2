  ...
  return (
    <div>
      <div className="fixed w-full h-full flex justify-center items-center bg-slate-900 transform transition-transform duration-200 ease" >
        <form onSubmit={handleSubmit(Submit)} className='w-5/6 md:w-3/6 xl:w-2/6 shadow-2xl shadow-cyan-400/50  bg-white rounded-[50px] flex flex-col items-center py-8 px-2' action="">
          ...
          <section className='w-full flex flex-col items-center'>
            ...
            <div className='w-full flex justify-center items-center'>
              <button onClick={handleReset} className='w-2/6 bg-slate-600 text-white text-base  py-1 rounded-[18px] hover:bg-slate-500'>RESET</button>
            </div>
          </section>
        </form>
      </div>
